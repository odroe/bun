...
_$_ModelMapping _$$_ModelMappingFromJson(Map<String, dynamic> json) =>
    _$_ModelMapping(
      ...
      findUnique: _oneSuffixReader(json, 'findUnique') as String?,
      findUniqueOrThrow: _oneSuffixReader(json, 'findUniqueOrThrow') as String?,
      findFirst: _oneSuffixReader(json, 'findFirst') as String?,
      findFirstOrThrow: _oneSuffixReader(json, 'findFirstOrThrow') as String?,
      findMany: _oneSuffixReader(json, 'findMany') as String?,
      create: _oneSuffixReader(json, 'create') as String?,
      createMany: _oneSuffixReader(json, 'createMany') as String?,
      update: _oneSuffixReader(json, 'update') as String?,
      updateMany: _oneSuffixReader(json, 'updateMany') as String?,
      upsert: _oneSuffixReader(json, 'upsert') as String?,
      delete: _oneSuffixReader(json, 'delete') as String?,
      deleteMany: _oneSuffixReader(json, 'deleteMany') as String?,
      aggregate: _oneSuffixReader(json, 'aggregate') as String?,
      groupBy: _oneSuffixReader(json, 'groupBy') as String?,
      count: _oneSuffixReader(json, 'count') as String?,
      findRaw: _oneSuffixReader(json, 'findRaw') as String?,
      aggregateRaw: _oneSuffixReader(json, 'aggregateRaw') as String?,
    );
